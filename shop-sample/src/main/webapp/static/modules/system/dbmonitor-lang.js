...
Public.lang = function() {
	...
	function setText($obj) {
		var key = $obj.attr('langKey') || $obj.data('langkey');
		if (typeof(lang[key]) != 'undefined') {
			var text = lang[key][Public.lang.langNow];
			$obj.text(lang[key][Public.lang.langNow]);
		} else {
	...
	function setTitle($obj) {
		var key = $obj.attr('langKey') || $obj.data('langkey');
		if (typeof(lang[key]) != 'undefined') {
			var title = lang[key][Public.lang.langNow];
	...
	return {
		...
		init : function(langNow) {
			...
			$(document).on('click','.langSelector',function() {
				...
				Public.lang.setLangType(langSelected);
				Public.lang.trigger();
				return false;
			});
		},
