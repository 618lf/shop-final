...
var Payment = function() {
	...
	this.getJsPayUrl = function(){
		return webRoot + '/f/member/shop/order/payment/plugin_ajax_submit';
	};
	this.getNaPayUrl = function(){
		return webRoot + '/f/member/shop/order/payment/plugin_ajax_submit/native';
	};
	this.getTouchUrl = function(){
		return webRoot + '/f/member/shop/order/payment/touch';
	};
	this.render = function(id) {
		Public.close();
		Public.success('支付完成', function() {
			window.location.href = webRoot + '/f/member/shop/order/view/' + id + '.html';
		});
	};
