...
<script src="${ctxStatic}/jquery-form/jquery.citypicker.data.js?v=${version}" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-form/jquery.citypicker.js" type="text/javascript"></script>
...
<script type="text/html" id="fixedBtns">
<div class="fixed-btns">
  <a class="top-btn" data-action="top"><i class="iconfont icon-chevron-up"></i><span>顶部</span></a>
  <a class="bottom-btn" data-action="bottom"><i class="iconfont icon-chevron-down"></i><span>底部</span></a>
</div>
</script>
