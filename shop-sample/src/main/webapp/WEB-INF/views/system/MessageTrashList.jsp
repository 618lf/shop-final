...
<div class="wrapper message-wrap">
    <div class="wrapper-inner">
        <ul class="nav-tabs">
          ...
          <li class="active"><a href="${ctx}/system/message/trashBox"><i class="fa fa-trash"></i>垃圾箱</a></li>
        </ul>
		<div class="top">
...
var THISPAGE = {
	...
	loadGrid : function(){
		...
		$('#grid').jqGrid(
			Public.defaultGrid({
				url: '${ctx}/system/message/jSonTrashList?timeid='+ Math.random(),
				height:init.h,
				shrinkToFit:!1, 
				rownumbers: !0,//序号
				multiselect:true,//定义是否可以多选
				multiboxonly: false,
				colNames: ['ID', '标题', '内容', '发件人', '收件人', '发件时间', ''],
				colModel: [
                    {name:'id', index:'id', width:80,sortable:false,hidden:true},
	                {name:'title', index:'title', width:250, sortable:false},
