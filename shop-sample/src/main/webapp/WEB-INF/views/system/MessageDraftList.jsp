...
<div class="wrapper message-wrap">
    <div class="wrapper-inner">
        <ul class="nav-tabs">
          ...
          <li class="active"><a href="${ctx}/system/message/draftBox"><i class="fa fa-pencil green"></i>草稿箱</a></li>
		...
		<div class="top">
		    <form name="queryForm" id="queryForm">
				<div class="fl">
				  ...
				  <a class="btn btn-default" id="delBtn">删除</a>
				  <a class="btn btn-default" id="sendBtn">发送</a>
...
var THISPAGE = {
	...
	loadGrid : function(){
		...
		var optionsFmt = function (cellvalue, options, rowObject) {
			var text =  "<i class='iconfont icon-edit detail draft' data-id='"+rowObject.id+"' data-msg='"+rowObject.title+"' title='编辑'></i>";
		        text += "<i class='iconfont icon-remove delete' data-id='"+rowObject.id+"' title='删除'></i>";
		    return text;
		};

		$('#grid').jqGrid(
				Public.defaultGrid({
					url: '${ctx}/system/message/jSonDraftList?timeid='+ Math.random(),
					height:init.h,
					shrinkToFit:!1, 
					rownumbers: !0,//序号
					multiselect:true,//定义是否可以多选
					multiboxonly: false,
					colNames: ['ID', '标题', '内容', '收件人', '创建时间', ''],
					colModel: [
	...
	addEvent : function(){
		...
		var send = function(t){
			if( !!t ) {
				...
				Public.deletex("确定发送选中的邮件？","${ctx}/system/message/batchSend",param,function(data){
