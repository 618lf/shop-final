 ...
 * @author lifeng
 */
public class SignInHandler implements ReportHandler<User> {

	// 插入数据
	private String sql = "INSERT INTO REPORT_USERZ(REPORT_DATE, QUANTITY) VALUES(:REPORT_DATE, :QUANTITY) ON DUPLICATE KEY UPDATE QUANTITY = QUANTITY + 1";
