...
public class GroupService extends BaseService<Group, Long> implements GroupServiceFacade{
    ...
    public List<Group> findByCodes(String codes){
    	String _key = new StringBuilder(SystemConstant.CACHE_GROUP).append(codes).toString();
     ...
     */
  	public static void removeCache(Group group){
  		if(group != null) {
  			CacheUtils.evict(new StringBuilder(SystemConstant.CACHE_GROUP_MENUS).append(group.getId()).toString());
  			CacheUtils.evict(new StringBuilder(SystemConstant.CACHE_GROUP).append("*").toString());
  		}
  	}
  	...
  	public void removeGroupMenus() {
  		CacheUtils.evict(new StringBuilder(SystemConstant.CACHE_GROUP_MENUS).append("*").toString());
  	}
}