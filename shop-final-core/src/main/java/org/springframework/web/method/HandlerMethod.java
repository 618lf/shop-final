...
import com.tmt.core.security.permission.PermissionHandlerMethod;
 ...
 * obtain a {@code HandlerMethod} instance with a bean instance resolved through
 ...
 * @since 3.1
 */
public class HandlerMethod extends PermissionHandlerMethod {
	...
	/**
	 * Return {@code true} if the method return type is void, {@code false}
	 * otherwise.
	 */
	...
	/**
	 * Return a single annotation on the underlying method traversing its super
	...
	/**
	 * Return the HandlerMethod from which this HandlerMethod instance was resolved
	 * via {@link #createWithResolvedBean()}.
	 */
	@Nullable
	 ...
	 * the bean name is resolved before a {@link HandlerMethod} is created and
	 * returned.
	 */
	...
	/**
	 * Return a short representation of this handler method for log message
	 * purposes.
	 * 
	 * @since 4.3
	 */
	...
	/**
	 * A MethodParameter for a HandlerMethod return type based on an actual return
	 * value.
	 */
