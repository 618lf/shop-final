...
public class RedisSessionRepository implements SessionRepository<RedisSession> {
	 ...
	 */
	@Override
	public RedisSession createSession(HttpServletRequest request, Principal principal, boolean authenticated) {
	 ...
	 */
	@Override
	public RedisSession getSession(HttpServletRequest request, String id) {
