package com.tmt.core.security.subject;
...
public interface Subject {
	...
	/**
	 * 能唯一标识一个用户登录有效的字符串 cookieSession 中的sessionId token 中的 key
	 * 
	 * @return
	 */
	String getSessionId();
	 ...
	 * @return 异步结果
	 */
	boolean hasRole(Permission role);
	 ...
	 * @throws AuthenticationException
	 */
	void login(Principal principal, HttpServletRequest request, HttpServletResponse response)
			throws AuthenticationException;
