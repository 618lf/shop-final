...
public class SecurityFilter extends OncePerRequestFilter {
	...
	protected void accessLog(Subject subejct, HttpServletRequest request, long t1, Throwable ex) {
		...
		ACCESS_LOG.info("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}", 
			    IdGen.key(), 
			    (byte)(_ex == null ? 1 : 2), 
			    createId == null?"\\N":createId, 
			    StringUtil3.defaultIfBlank(createName, "\\N"), 
			    DateUtil3.getTimeStampNow(),
			    WebUtils.getRemoteAddr(request), 
			    StringUtil3.abbr(request.getHeader("user-agent"), 255), 
			    _url, 
			    request.getMethod(), 
			    (int)(System.currentTimeMillis() - t1), 
			    StringUtil3.defaultIfBlank("", "\\N"), 
			    StringUtil3.defaultIfBlank(StringUtil3.isNoneBlank(referer)?StringUtil3.abbr(referer, 255):null, "\\N")); 
	 ...
	 */
	protected void executeChain(HttpServletRequest request, HttpServletResponse response, FilterChain origChain) throws IOException, ServletException {
