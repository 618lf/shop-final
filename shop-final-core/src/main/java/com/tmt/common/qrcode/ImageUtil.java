...
public class ImageUtil {
	...
	public static BufferedImage getImageByPath(String path) throws IOException {
		...
		return ImageIO.read(StorageUtils.download(path));
	}
	 ...
	 * @throws IOException
	 */
	public static void insertLogo(BufferedImage qrCode, String logo, QrcodeOptions.LogoStyle logoStyle,
	 ...
	 * @throws IOException
	 */
	public static BufferedImage drawBackground(BufferedImage source, String background, int bgW, int bgH)
			throws IOException {
