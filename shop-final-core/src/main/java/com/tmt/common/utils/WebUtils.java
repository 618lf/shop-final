...
import com.tmt.common.security.utils.RedirectView;
import com.tmt.common.web.security.cookie.CookieProvider;
import com.tmt.common.web.useragent.DeviceType;
import com.tmt.common.web.useragent.UserAgent;
...
public class WebUtils extends org.springframework.web.util.WebUtils{
	...
	public static MultipartFile[] uploadFile( HttpServletRequest request ){
		...
		//自己解析上传文件，
		CommonsMultipartResolver multipartResolver = new CommonsMultipartResolver(XSpringContextHolder.getServletContext());
	 ...
	 * @param fallbackUrl
	 */
	public static void redirectToSavedRequest(HttpServletRequest request, HttpServletResponse response, String fallbackUrl) throws IOException {
	 ...
	 * @return
	 */
	public static String getAndClearSavedRequest(HttpServletRequest request, HttpServletResponse response, String fallbackUrl) {
		String successUrl = null;
		if(request == null) {
			request = ContextHolderUtils.getRequest();
		}
	 ...
	 * @throws IOException
	 */
    public static void issueRedirect(HttpServletRequest request, HttpServletResponse response, String url, Map<String, ?> queryParams, boolean contextRelative) throws IOException {
	...
	public static void makerNewUser(HttpServletResponse response) {
		CookieUtils.setCookie(response, Globals.NEW_USER, String.valueOf(BaseEntity.YES), -1);
	}
	...
	public static void removeNewUser(HttpServletRequest request, HttpServletResponse response) {
		CookieUtils.remove(request, response, Globals.NEW_USER);
	}
	...
	public static Boolean isNewUser(HttpServletRequest request) {
		String nu = CookieUtils.getCookie(request,  Globals.NEW_USER);
