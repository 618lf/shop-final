...
public class Refundorder {
	...
	public void checkAndSign(WechatPayConfig config) throws Exception {
		...
		if ((StringUtil3.isBlank(this.getOut_trade_no()) && StringUtil3.isBlank(this.getTransaction_id()))
				|| StringUtil3.isBlank(this.getOut_refund_no())
				|| StringUtil3.isBlank(this.getTotal_fee())
				|| StringUtil3.isBlank(this.getRefund_fee())) {
