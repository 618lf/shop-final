...
public class Unifiedorder {
	 ...
	 * @throws Exception 
	 */
	public void checkAndSign(WechatPayConfig config) throws Exception {
		if (StringUtil3.isBlank(this.getNotify_url())) {
	        this.setNotify_url(config.getNotifyUrl());
	    }
		if (StringUtil3.isBlank(getAppid())) {
			this.setAppid(config.getAppId());
		}
		if (StringUtil3.isBlank(this.getMch_id())) {
			this.setMch_id(config.getMchId());
		}
		if (StringUtil3.isBlank(this.getNonce_str())) {
			this.setNonce_str(UUIdGenerator.uuid());
		}
		if (StringUtil3.isBlank(this.getBody()) 
				|| StringUtil3.isBlank(this.getOut_trade_no())
				|| StringUtil3.isBlank(this.getTotal_fee())
				|| StringUtil3.isBlank(this.getTrade_type())
				|| StringUtil3.isBlank(this.getSpbill_create_ip())) {
