...
public class SignUtils {
	...
	public static String generateSign(Object object, String signType, String paternerKey) throws Exception {
		...
		if (StringUtil3.isNotBlank(signType) && WechatConstants.MD5.equals(signType)) {
			return MD5(str).toUpperCase();
		} else if(StringUtil3.isNotBlank(signType) && WechatConstants.HMACSHA256.equals(signType)) {
	 ...
	 * @throws Exception 
	 */
	public static String generateSign(Map<String, String> object, String signType, String paternerKey) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public static String generateMchPayJsRequestJson(String nonceStr, String prepay_id, String appId, String paternerKey) {
