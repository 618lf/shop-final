...
public class UploadConfig {
	...
	public Map<String, Object> getConfig(Site site, Action type) {
		...
		case uploadfile:
			...
			conf.put("maxSize",
					Ints.defaultInteger(
							site.getUploadFileMaxSize() != null ? (site.getUploadFileMaxSize() * 1024 * 1024) : null,
							(Integer) config.get("fileMaxSize")));
			conf.put("allowFiles",
		...
		case uploadimage:
			...
			conf.put("maxSize",
					Ints.defaultInteger(
							site.getUploadImageMaxSize() != null ? (site.getUploadImageMaxSize() * 1024 * 1024) : null,
							(Integer) config.get("imageMaxSize")));
			conf.put("allowFiles",
		...
		case uploadvideo:
			...
			conf.put("maxSize",
					Ints.defaultInteger(
							site.getUploadMediaMaxSize() != null ? (site.getUploadMediaMaxSize() * 1024 * 1024) : null,
							(Integer) config.get("videoMaxSize")));
			conf.put("allowFiles",
